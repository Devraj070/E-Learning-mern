...
const uploadFeaturedProduct = require('../../controller/product/uploadFeaturedProduct');
...
router.post('/upload-featured-product-details', upload.single('image'), uploadFeaturedProduct.uploadFeaturedProduct);
